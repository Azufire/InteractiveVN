...
app.post("/in",body("username", "password").trim().isLength({ min: 1 }).withMessage("Invalid input detected. Please check your fields.").escape(), (req, res) => {
    const errors = validationResult(req);
    console.log("login form recieved");
    if(errors.isEmpty()) {
